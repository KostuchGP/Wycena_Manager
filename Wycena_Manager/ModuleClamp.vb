Public Class ModuleClamp
    ...
    Public Sub PrzeliczClamp(ByVal pyt2 As Integer, ByVal pyt3 As Integer, ByVal pyt4 As Integer, ByVal num2 As Integer, ByVal num3 As Integer, ByVal num4 As Integer)
        ...
        Else
            ...
            Form1.LvwMain.Items(1).SubItems(5).Text = Math.Floor(ClampArray(1, pyt2) * num2)
        End If
        'PRZELICZNIKI ZAWOR
        ...
        Else
            ...
            Form1.LvwMain.Items(2).SubItems(5).Text = Math.Floor(ClampArray(1, pyt2) * 0.025)
        End If
        'PRZELICZNIKI KOSC
        ...
        If pyt2 = 0 Then ' Czyli jak nie ma siłownika to średnia cena 1500 zł
            Form1.LvwMain.Items(3).SubItems(2).Text = Math.Floor(1500 * 0.03 * num3)
            Form1.LvwMain.Items(3).SubItems(3).Text = Math.Floor(1500 * 0.2 * num3)
            Form1.LvwMain.Items(3).SubItems(4).Text = Math.Floor(1500 * 0.028 * num3)
        Else
            Form1.LvwMain.Items(3).SubItems(2).Text = Math.Floor(ClampArray(1, pyt2) * 0.03 * num3)
            Form1.LvwMain.Items(3).SubItems(3).Text = Math.Floor(ClampArray(1, pyt2) * 0.2 * num3)
            Form1.LvwMain.Items(3).SubItems(4).Text = Math.Floor(ClampArray(1, pyt2) * 0.028 * num3)
        End If
        ...
        ElseIf pyt2 = 0 Then ' Czyli jak nie ma siłownika to średnia cena 300 zł, a ma być konsola
            ...
            Form1.LvwMain.Items(5).SubItems(2).Text = Math.Floor(1500 * 0.06 * num4)
            Form1.LvwMain.Items(5).SubItems(3).Text = Math.Floor(1500 * 0.23 * num4)
            Form1.LvwMain.Items(5).SubItems(4).Text = Math.Floor(1500 * 0.03 * num4)
        Else
            Form1.LvwMain.Items(5).SubItems(1).Text = 1
            Form1.LvwMain.Items(5).SubItems(2).Text = Math.Floor(ClampArray(1, pyt2) * 0.06 * num4)
            Form1.LvwMain.Items(5).SubItems(3).Text = Math.Floor(ClampArray(1, pyt2) * 0.23 * num4)
            Form1.LvwMain.Items(5).SubItems(4).Text = Math.Floor(ClampArray(1, pyt2) * 0.03 * num4)
        End If
        ...
        Else
            Form1.LvwMain.Items(6).SubItems(1).Text = 1
            Form1.LvwMain.Items(6).SubItems(7).Text = Math.Floor(ClampArray(1, pyt2) * 0.07 * num2)
        End If
